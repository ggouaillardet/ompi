...
static void __ompi_temp_datatype_allocate( ompi_datatype_t* datatype )
{
...
OBJ_CLASS_INSTANCE(ompi_temp_datatype_t, opal_datatype_t, __ompi_temp_datatype_allocate, __ompi_datatype_release);
...
{
    int ret;
    ompi_datatype_t * datatype = (ompi_datatype_t *)OBJ_NEW(ompi_temp_datatype_t);
