...
int
mca_io_romio33_file_write_at (ompi_file_t *fh,
                            MPI_Offset offset,
                            const void *buf,
                            int count,
...
int
mca_io_romio33_file_write_at_all (ompi_file_t *fh,
                                MPI_Offset offset,
                                const void *buf,
                                int count,
                                struct ompi_datatype_t *datatype,
...
int
mca_io_romio33_file_iwrite_at (ompi_file_t *fh,
                             MPI_Offset offset,
                             const void *buf,
                             int count,
                             struct ompi_datatype_t *datatype,
...
int
mca_io_romio33_file_iwrite_at_all (ompi_file_t *fh,
                                    MPI_Offset offset,
                                    const void *buf,
                                    int count,
                                    struct ompi_datatype_t *datatype,
...
int
mca_io_romio33_file_write (ompi_file_t *fh,
                         const void *buf,
                         int count,
                         struct ompi_datatype_t *datatype,
                         ompi_status_public_t * status)
...
int
mca_io_romio33_file_write_all (ompi_file_t *fh,
                             const void *buf,
                             int count,
                             struct ompi_datatype_t *datatype,
                             ompi_status_public_t * status)
...
int
mca_io_romio33_file_iwrite (ompi_file_t *fh,
                          const void *buf,
                          int count,
                          struct ompi_datatype_t *datatype,
                          ompi_request_t **request)
...
int
mca_io_romio33_file_iwrite_all (ompi_file_t *fh,
                                const void *buf,
                                 int count,
                                 struct ompi_datatype_t *datatype,
                                 ompi_request_t **request)
...
int
mca_io_romio33_file_write_shared (ompi_file_t *fh,
                                const void *buf,
                                int count,
                                struct ompi_datatype_t *datatype,
                                ompi_status_public_t * status)
...
int
mca_io_romio33_file_iwrite_shared (ompi_file_t *fh,
                                 const void *buf,
                                 int count,
                                 struct ompi_datatype_t *datatype,
                                 ompi_request_t **request)
...
int
mca_io_romio33_file_write_ordered (ompi_file_t *fh,
                                 const void *buf,
                                 int count,
                                 struct ompi_datatype_t *datatype,
                                 ompi_status_public_t * status)
...
int
mca_io_romio33_file_write_at_all_begin (ompi_file_t *fh,
                                      MPI_Offset offset,
                                      const void *buf,
                                      int count,
                                      struct ompi_datatype_t *datatype)
...
int
mca_io_romio33_file_write_at_all_end (ompi_file_t *fh,
                                    const void *buf,
                                    ompi_status_public_t * status)
{
    int         ret;
...
int
mca_io_romio33_file_write_all_begin (ompi_file_t *fh,
                                   const void *buf,
                                   int count,
                                   struct ompi_datatype_t *datatype)
{
...
int
mca_io_romio33_file_write_all_end (ompi_file_t *fh,
                                 const void *buf,
                                 ompi_status_public_t * status)
{
    int         ret;
...
int
mca_io_romio33_file_write_ordered_begin (ompi_file_t *fh,
                                       const void *buf,
                                       int count,
                                       struct ompi_datatype_t *datatype)
{
...
int
mca_io_romio33_file_write_ordered_end (ompi_file_t *fh,
                                     const void *buf,
                                     ompi_status_public_t * status)
{
    int         ret;
