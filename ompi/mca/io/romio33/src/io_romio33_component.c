...
static char *ompi_io_romio33_version = ROMIO_VERSION_STRING;
static char *ompi_io_romio33_user_configure_params = MCA_io_romio33_USER_CONFIGURE_FLAGS;
static char *ompi_io_romio33_complete_configure_params = MCA_io_romio33_COMPLETE_CONFIGURE_FLAGS;

static int register_component(void)
{
    /* Use a low priority, but allow other components to be lower */
    priority_param = 10;
    (void) mca_base_component_var_register(&mca_io_romio33_component.io_version,
    ...
    (void) mca_base_component_var_register(&mca_io_romio33_component.io_version,
                                           ...
                                           OPAL_INFO_LVL_9,
                                           MCA_BASE_VAR_SCOPE_READONLY, &ompi_io_romio33_version);
    (void) mca_base_component_var_register(&mca_io_romio33_component.io_version,
                                           ...
                                           OPAL_INFO_LVL_9,
                                           MCA_BASE_VAR_SCOPE_READONLY, &ompi_io_romio33_user_configure_params);
    (void) mca_base_component_var_register(&mca_io_romio33_component.io_version,
                                           ...
                                           MCA_BASE_VAR_FLAG_DEFAULT_ONLY,
                                           OPAL_INFO_LVL_9,
                                           MCA_BASE_VAR_SCOPE_READONLY, &ompi_io_romio33_complete_configure_params);
...
{
    /* Create the mutex */
    OBJ_CONSTRUCT(&mca_io_romio33_mutex, opal_mutex_t);
...
static int close_component(void)
{
    OBJ_DESTRUCT(&mca_io_romio33_mutex);
           ...
           int *priority)
{
    ...
    *priority = priority_param;
    ...
    data = malloc(sizeof(mca_io_romio33_data_t));
    if (NULL == data) {
        return NULL;
    }
    data->romio_fh = NULL;
