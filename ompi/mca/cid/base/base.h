...
OMPI_DECLSPEC    int ompi_cid_base_select(void);
...
OMPI_DECLSPEC ompi_cid_base_cid_context_t *ompi_cid_base_cid_context_alloc (ompi_communicator_t *newcomm, ompi_communicator_t *comm,
