...
#ifndef MCA_OP_NEON_EXPORT_H
#define MCA_OP_NEON_EXPORT_H
...
typedef struct {
    ...
    uint32_t flags; /* NEON capabilities supported by the processor */
} ompi_op_neon_component_t;

/**
 * Globally exported variable.  Note that it is a *neon* component
 ...
 */
OMPI_DECLSPEC extern ompi_op_neon_component_t
    mca_op_neon_component;

END_C_DECLS

#endif /* MCA_OP_NEON_EXPORT_H */
