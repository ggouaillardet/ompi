...
static int mca_op_sve_priority;
 ...
 */
static int
sve_component_register(void)
{
    mca_op_sve_priority = 40;
    (void) mca_base_component_var_register(&mca_op_sve_component.super.opc_version, "priority",
                                           "Priority of the sve op component",
 ...
 */
static int
sve_component_init_query(bool enable_progress_threads,
                          bool enable_mpi_thread_multiple)
{
    return OMPI_SUCCESS;
}
