...
#pragma weak PMPIX_NEIGHBOR_ALLTOALLX = ompix_neighbor_alltoall_init_f
...
#else
OMPI_GENERATE_F77_BINDINGS (PMPIX_NEIGHBOR_ALLTOALLX,
...
#if OPAL_HAVE_WEAK_SYMBOLS
#pragma weak MPIX_NEIGHBOR_ALLTOALLX = ompix_neighbor_alltoall_init_f
...
#else
#if ! OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS (MPIX_NEIGHBOR_ALLTOALLX,
