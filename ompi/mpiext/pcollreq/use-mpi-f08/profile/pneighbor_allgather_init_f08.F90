...
subroutine PMIX_neighbor_allgather_init_f08(sendbuf,sendcount,sendtype,recvbuf,recvcount,recvtype,comm,info,request,ierror)
...
end subroutine PMIX_neighbor_allgather_init_f08
