...
subroutine PMIX_reduce_scatter_block_init_f08(sendbuf,recvbuf,recvcount,datatype,op,comm,info,request,ierror)
...
end subroutine PMIX_reduce_scatter_block_init_f08
